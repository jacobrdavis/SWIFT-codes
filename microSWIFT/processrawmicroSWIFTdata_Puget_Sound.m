...
%% Settings and inputs:
% dataDir = '/Users/jacob/Dropbox/Projects/microSWIFT/onboard_development/data/2022-03-17 PugetSound/microSWIFT/Deployment_3/';
...
% plot 2: gyro about x
figure; hold on
plot(datetime(IMU(1).time,'ConvertFrom','datenum'),IMU(1).gyro(:,1),'Marker','*')
...
plot(datetime(IMU(3).time,'ConvertFrom','datenum'),IMU(3).pos(:,3),'Marker','*')
legend(mSWIFTlabels)
...
evalPlots(mSWIFT,mSWIFTlabels,methodNames,colors,styles);
